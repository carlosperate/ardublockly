			...
			class CVariableArray
			{
				...
				add(Variable)
				{
					this.m_arrayVariables.push(Variable);
				}
				...
				getValue(strVariableName)
				{
					var nI = this.indexOf(strName);
					return this.getValue(nI);
				}
				
				getType(strVariableName)
				{
					var nI = this.indexOf(strName);
					return this.getType(nI);
				}
			...
			g_arrayArduinoFunctions = ["Serial.print", "Serial.println", "Serial.begin", "digtalRead", "digtalWrite", 
										"analogRead", "analogWrite", "pinMode", "setup", "loop"];
