...
goog.provide('Blockly.Language.en');
...
Blockly.LANG_COLOUR_RGB_TOOLTIP = 'Create a colour with the specified amount of red, green, and blue.  All values must be between 0 and 100.';
...
Blockly.LANG_CONTROLS_WHILEUNTIL_INPUT_DO = Blockly.LANG_CONTROLS_REPEAT_INPUT_DO;
...
Blockly.LANG_CONTROLS_FOR_HELPURL = 'https://code.google.com/p/blockly/wiki/Loops#count_with';
...
Blockly.LANG_CONTROLS_FOR_TOOLTIP = 'Have the variable %1 take on the values from the start number to the end number, counting by the specified interval, and do the specified blocks.';
...
Blockly.LANG_CONTROLS_FOR_INPUT_DO = Blockly.LANG_CONTROLS_REPEAT_INPUT_DO;
...
Blockly.LANG_CONTROLS_FOREACH_HELPURL = 'https://code.google.com/p/blockly/wiki/Loops#for_each for each block';
...
Blockly.LANG_CONTROLS_FOREACH_INPUT_VAR = Blockly.LANG_CONTROLS_FOR_INPUT_VAR;
...
Blockly.LANG_CONTROLS_FOREACH_INPUT_DO = Blockly.LANG_CONTROLS_REPEAT_INPUT_DO;
///block text - Description of [https://code.google.com/p/blockly/wiki/Loops#for_each for each blocks].\n\nParameters:\n* %1 - the name of the loop variable.
Blockly.LANG_CONTROLS_FOREACH_TOOLTIP = 'For each item in a list, set the variable "%1" to the item, and then do some statements.';
...
Blockly.LANG_CONTROLS_FLOW_STATEMENTS_HELPURL = 'https://code.google.com/p/blockly/wiki/Loops#Loop_Termination_Blocks';
...
Blockly.LANG_CONTROLS_IF_MSG_THEN = Blockly.LANG_CONTROLS_REPEAT_INPUT_DO;
...
///tooltip - Describes the equals (&lt;) block.
Blockly.LANG_LOGIC_COMPARE_TOOLTIP_LT = 'Return true if the first input is smaller than the second input.';
///tooltip - Describes the equals (&le;) block.
Blockly.LANG_LOGIC_COMPARE_TOOLTIP_LTE = 'Return true if the first input is smaller than or equal to the second input.';
///tooltip - Describes the equals (&gt;) block.
Blockly.LANG_LOGIC_COMPARE_TOOLTIP_GT = 'Return true if the first input is greater than the second input.';
///tooltip - Describes the equals (&ge;) block.
Blockly.LANG_LOGIC_COMPARE_TOOLTIP_GTE = 'Return true if the first input is greater than or equal to the second input.';
...
Blockly.LANG_LOGIC_OPERATION_TOOLTIP_OR = 'Return true if at least one of the inputs is true.';
///block text - See [http://en.wikipedia.org/wiki/Disjunction http://en.wikipedia.org/wiki/Disjunction].
...
Blockly.LANG_LOGIC_TERNARY_TOOLTIP = 'Check the condition in "test". If the condition is true, returns the "if true" value; otherwise returns the "if false" value.';
...
Blockly.LANG_MATH_ARITHMETIC_TOOLTIP_POWER = 'Return the first number raised to the power of the second number.';
...
Blockly.LANG_MATH_CONSTANT_TOOLTIP = 'Return one of the common constants: \u03c0 (3.141\u2026), e (2.718\u2026), \u03c6 (1.618\u2026), sqrt(2) (1.414\u2026), sqrt(\u00bd) (0.707\u2026), or \u221e (infinity).';
...
Blockly.LANG_MATH_IS_TOOLTIP = 'Check if a number is an even, odd, prime, whole, positive, negative, or if it is divisible by certain number.  Returns true or false.';
...
Blockly.LANG_MATH_ONLIST_TOOLTIP_AVERAGE = 'Return the average (arithmetic mean) of the numeric values in the list.';
...
Blockly.LANG_MATH_RANDOM_INT_INPUT_TO = Blockly.LANG_CONTROLS_FOR_INPUT_TO = 'to';
...
Blockly.LANG_MATH_RANDOM_INT_TOOLTIP = 'Return a random integer between the two specified limits, inclusive.';
...
Blockly.LANG_TEXT_LENGTH_HELPURL = 'https://code.google.com/p/blockly/wiki/Text#Text_modification';
...
Blockly.LANG_TEXT_ISEMPTY_HELPURL = 'https://code.google.com/p/blockly/wiki/Text#Checking_for_empty_text';
...
Blockly.LANG_TEXT_INDEXOF_HELPURL = 'https://code.google.com/p/blockly/wiki/Text#Finding_text';
...
Blockly.LANG_TEXT_TRIM_TOOLTIP = 'Return a copy of the text with spaces removed from one or both ends.';
...
Blockly.LANG_LISTS_REPEAT_HELPURL = 'https://code.google.com/p/blockly/wiki/Lists#create_list_with'
...
Blockly.LANG_LISTS_LENGTH_HELPURL = 'https://code.google.com/p/blockly/wiki/Lists#length_of';
...
Blockly.LANG_LISTS_IS_EMPTY_HELPURL = 'https://code.google.com/p/blockly/wiki/Lists#is_empty';
