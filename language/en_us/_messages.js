...
goog.provide('Blockly.Language.en_us');
...
Blockly.LANG_COLOUR_PICKER_TOOLTIP = 'Choose a color from the palette.';

Blockly.LANG_COLOUR_RANDOM_HELPURL = 'http://randomcolour.com';
Blockly.LANG_COLOUR_RANDOM_TITLE = 'random color';
Blockly.LANG_COLOUR_RANDOM_TOOLTIP = 'Choose a color at random.';

Blockly.LANG_COLOUR_RGB_HELPURL = 'http://www.december.com/html/spec/colorper.html';
Blockly.LANG_COLOUR_RGB_TITLE = 'color with';
Blockly.LANG_COLOUR_RGB_RED = 'red';
Blockly.LANG_COLOUR_RGB_GREEN = 'green';
Blockly.LANG_COLOUR_RGB_BLUE = 'blue';
Blockly.LANG_COLOUR_RGB_TOOLTIP = 'Create a color with the specified amount of red, green,\n' +
...
Blockly.LANG_COLOUR_BLEND_TOOLTIP = 'Blends two colors together with a given ratio (0.0 - 1.0).';
