...
Blockly.Blocks['logic_operation'] = {
  ...
  getBlockType: function() {
    Blockly.StaticTyping.BlocklyTypes.BOOLEAN;
  }
};
      ...
      "args0": [
        {
          "type": "input_value",
          "name": "BOOL",
          "check": Blockly.StaticTyping.BlocklyTypes.BOOLEAN.compatibles()
        }
      ],
...
Blockly.Blocks['logic_null'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "output": Blockly.StaticTyping.BlocklyTypes.NULL.basicType,
      "colour": Blockly.Blocks.logic.HUE,
  ...
  getBlockType: function() {
    return Blockly.StaticTyping.BlocklyTypes.NULL;
  }
};
