...
Blockly.Msg.ARD_NOTONE = "Отключить частоту на выходе  №";  // untranslated
...
Blockly.Msg.ARD_SERIAL_SETUP = "Найстройка";  // untranslated
...
Blockly.Msg.ARD_SPI_SETUP_MODE = "Режим SPI  (idle - edge)";  // untranslated
...
Blockly.Msg.ARD_SPI_TRANS_TIP = "Отправляет сообщение SPI в определенное ведомое устройство.";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_VAL = "перенос";  // untranslated
