...
Blockly.Msg.ARD_ANALOGREAD = "Считать значения с аналогового входа №";  
Blockly.Msg.ARD_ANALOGREAD_TIP = "Возвращает значение от 0 до 1024";  
Blockly.Msg.ARD_ANALOGWRITE = "Установить значение аналогового выхода №";  
...
Blockly.Msg.ARD_DIGITALREAD_TIP = "Считать цифровое значение с пина: HIGH или LOW";  
Blockly.Msg.ARD_DIGITALWRITE = "Установить значение цифрового пина ";  
Blockly.Msg.ARD_DIGITALWRITE_TIP = "Записать цифровое значение HIGH или LOW на указанный пин";  
...
Blockly.Msg.ARD_HIGHLOW_TIP = "Установить значения HIGH или LOW для цифрового выхода";  
...
Blockly.Msg.ARD_NOTONE = "Отключить частоту на пине №";  // untranslated
Blockly.Msg.ARD_NOTONE_PIN = "Вход/выход без поддержки генерации прямоугольного сигнала  №";  // untranslated
Blockly.Msg.ARD_NOTONE_PIN_TIP = "Остановить генерацию прямоугольного сигнала на выходе";  // untranslated
Blockly.Msg.ARD_NOTONE_TIP = "Останавливает генерацию прямоугольного сигнала на выбранном пине";  // untranslated
Blockly.Msg.ARD_PIN_WARN1 = "Пин %1 нужен для %2 в качестве %3. Но уже использован для %4.";  // untranslated
Blockly.Msg.ARD_PULSEON = "импульс на пине №";  // untranslated
Blockly.Msg.ARD_PULSEREAD = "Считать";  // untranslated
Blockly.Msg.ARD_PULSETIMEOUT = "с таймаутом ";  // untranslated
Blockly.Msg.ARD_PULSETIMEOUT_MS = "";  // untranslated
Blockly.Msg.ARD_PULSETIMEOUT_TIP = "Измеряет длительность импульса на выбранном пине, в течение таймаута.";  // untranslated
Blockly.Msg.ARD_PULSE_TIP = "Измеряет длительность импульса на выбранном пине.";  // untranslated
Blockly.Msg.ARD_SERIAL_BPS = "бит/с";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT = "вывести";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "добавить перенос строки";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT_TIP = "Выводит данные в консоль/последовательный порт в читаемом ASCII виде.";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT_WARN = "Блок настройки %1 должен быть добавлен для того чтобы использовать этот блок!";  // untranslated
Blockly.Msg.ARD_SERIAL_SETUP = "Настройка";  // untranslated
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "Задает скорость последовательного порта";  // untranslated
...
Blockly.Msg.ARD_SPI_SETUP = "Настройка интерфейса";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_CONF = ":";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_DIVIDE = "делитель частоты";  
Blockly.Msg.ARD_SPI_SETUP_LSBFIRST = "LSBFIRST";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_MODE = "Режим SPI  (полярность - фаза)";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_MODE0 = "0 (Низкий - Задний фронт)";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_MODE1 = "1 (Низкий - Передний фронт)";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_MODE2 = "2 (Высокий - Задний фронт)";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_MODE3 = "3 (Высокий - Передний фронт)";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_MSBFIRST = "MSBFIRST";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_SHIFT = "сдвиг данных";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_TIP = "Настраивает SPI.";  // untranslated
Blockly.Msg.ARD_SPI_TRANSRETURN_TIP = "Отправляет сообщение SPI в ведомое устройство и получает в ответ данные.";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_NONE = "пусто";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_SLAVE = "к ведомому пину";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_TIP = "Отправляет сообщение SPI в ведомое устройство.";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_VAL = "передача";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_WARN1 = "для блока %1 должен быть добавлен блок настроек!";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_WARN2 = "Старое значение пина %1 больше недоступно.";  // untranslated
Blockly.Msg.ARD_STEPPER_COMPONENT = "шаговик";  // untranslated
Blockly.Msg.ARD_STEPPER_DEFAULT_NAME = "MyStepper";  // untranslated
Blockly.Msg.ARD_STEPPER_MOTOR = "шагового мотора:";  // untranslated
Blockly.Msg.ARD_STEPPER_PIN1 = "пин1 №";  // untranslated
Blockly.Msg.ARD_STEPPER_PIN2 = "пин2 №";  // untranslated
Blockly.Msg.ARD_STEPPER_REVOLVS = "количество шагов за оборот";  // untranslated
Blockly.Msg.ARD_STEPPER_SETUP = "Конфигурация";  // untranslated
Blockly.Msg.ARD_STEPPER_SETUP_TIP = "Настраивает выходной пин шагового мотора и прочие свойства.";  // untranslated
Blockly.Msg.ARD_STEPPER_SPEED = "скорость, оборот/с";  // untranslated
Blockly.Msg.ARD_STEPPER_STEP = "запустить шаговый";  // untranslated
Blockly.Msg.ARD_STEPPER_STEPS = "шаг(ов)";  // untranslated
Blockly.Msg.ARD_STEPPER_STEP_TIP = "Поворачивает шаговый мотор на указанное количество шагов.";  // untranslated
Blockly.Msg.ARD_TIME_DELAY = "Ждать";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_MICROS = "микросекунд";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "Ждет заданное количество микросекунд";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_TIP = "Ждет заданное количество миллисекунд";  // untranslated
Blockly.Msg.ARD_TIME_INF = "Ждать бесконечно (останавливает программу)";  // untranslated
Blockly.Msg.ARD_TIME_INF_TIP = "Ждет неопределенное время, останавливая при этом программу.";  // untranslated
Blockly.Msg.ARD_TIME_MICROS = "прошло времени (в микросекундах)";  // untranslated
Blockly.Msg.ARD_TIME_MICROS_TIP = "Возвращает сколько микросекуд прошло с запуска Arduino в текущей программе. Значение должно храниться в большой переменной беззнакового типа";  // untranslated
Blockly.Msg.ARD_TIME_MILLIS = "прошло времени (в миллисекундах)";  // untranslated
Blockly.Msg.ARD_TIME_MILLIS_TIP = "Возвращает количество миллисекунд прошедших с запуска Arduino в текущей программе. Значение должно храниться в большой переменной беззнакового типа";  // untranslated
Blockly.Msg.ARD_TIME_MS = "миллисекунд";  // untranslated
Blockly.Msg.ARD_TONEFREQ = "частоту";  // untranslated
Blockly.Msg.ARD_TONE_FREQ = "частота";  // untranslated
Blockly.Msg.ARD_TONE_PIN = "Частота PIN №";  // untranslated
Blockly.Msg.ARD_TONE_PIN_TIP = "Генерирует звуковые частоты на пине";  // untranslated
Blockly.Msg.ARD_TONE_TIP = "Устанавливает частоту прямоугольных импульсов на пине в диапазоне 31 - 65535 Гц";  // untranslated
Blockly.Msg.ARD_TONE_WARNING = "Частота должна быть в диапазоне 31 - 65535 Гц";  // untranslated
Blockly.Msg.ARD_TYPE_ARRAY = "Массив";  // untranslated
Blockly.Msg.ARD_TYPE_BOOL = "Логическое";  // untranslated
Blockly.Msg.ARD_TYPE_CHAR = "Символ";  // untranslated
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "НетВложенногоБлока";  // untranslated
Blockly.Msg.ARD_TYPE_DECIMAL = "Числовое";  // untranslated
Blockly.Msg.ARD_TYPE_LONG = "Большое Число";  // untranslated
Blockly.Msg.ARD_TYPE_NULL = "Null";  // untranslated
Blockly.Msg.ARD_TYPE_NUMBER = "Число";  // untranslated
Blockly.Msg.ARD_TYPE_SHORT = "Маленькое Число";  // untranslated
Blockly.Msg.ARD_TYPE_TEXT = "Текст";  // untranslated
Blockly.Msg.ARD_TYPE_UNDEF = "Неопределенное";  // untranslated
Blockly.Msg.ARD_VAR_AS = "как";  // untranslated
Blockly.Msg.ARD_VAR_AS_TIP = "Приводит значение к определенному типу";  // untranslated
Blockly.Msg.ARD_WRITE_TO = "в";  // untranslated
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "Цикл выполняется пока значение ложно";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "Цикл выполняется пока значение истинно.";
...
Blockly.Msg.MATH_IS_TOOLTIP = "Проверяет, является ли число чётным, нечётным, простым, целым, положительным, отрицательным или кратным определённому числу.  Возвращает значение истина или ложь.";
Blockly.Msg.MATH_IS_WHOLE = "целое";
Blockly.Msg.MATH_MODULO_HELPURL = "https://ru.wikipedia.org/wiki/Деление_с_остатком";
Blockly.Msg.MATH_MODULO_TITLE = "остаток от деления %1 ÷ %2";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TITLE_RANDOM = "случайное число от 0.0 (включительно) до 1.0";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP = "Исполняет определённую пользователем функцию '%1'.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL = "https://ru.wikipedia.org/wiki/Функция_%28программирование%29";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP = "Исполняет определённую пользователем функцию '%1' и возвращает вычисленное  значение.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP = "Создаёт функцию, не возвращающую значение.";
Blockly.Msg.PROCEDURES_DEFRETURN_HELPURL = "https://en.wikipedia.org/wiki/Procedure_%28computer_science%29";  // untranslated
Blockly.Msg.PROCEDURES_DEFRETURN_RETURN = "вернуть";
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP = "Создаёт функцию, возвращающую значение.";
...
Blockly.Msg.RENAME_INSTANCE = "Переименовать экземпляры...";  // untranslated
Blockly.Msg.RENAME_INSTANCE_TITLE = "Переименовать все '%1' экземпляры в:";  // untranslated
