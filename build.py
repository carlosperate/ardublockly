...
def gen_uncompressed(search_paths):
  """Generate a JavaScript file that loads Blockly's raw files.

  Args:
      search_paths: List of Blockly and Closure files to scan.
  """
...
def gen_compressed(search_paths):
...
http://code.google.com/p/blockly/wiki/Closure"""
  ...
  gen_uncompressed(search_paths)
  gen_compressed(search_paths)
