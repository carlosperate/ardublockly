...
Blockly.Msg.COLOUR_PICKER_TOOLTIP = 'Choose a colour form the palette.';
...
Blockly.Msg.CONTROLS_WHILEUNTIL_INPUT_DO = '執行';
...
Blockly.Msg.CONTROLS_FOR_INPUT_VAR = '變量';
Blockly.Msg.CONTROLS_FOR_INPUT_FROM = '從範圍';
Blockly.Msg.CONTROLS_FOR_INPUT_TO = '到';
Blockly.Msg.CONTROLS_FOR_INPUT_BY = '每隔';
Blockly.Msg.CONTROLS_FOR_INPUT_DO = '執行';
Blockly.Msg.CONTROLS_FOR_TAIL = '';
Blockly.Msg.CONTROLS_FOR_TOOLTIP = 'Count from a start number to an end number by the specified interval.  For each count, set the current count number to variable "%1", and then do some statements.';

Blockly.Msg.CONTROLS_FOREACH_HELPURL = 'http://en.wikipedia.org/wiki/For_loop';
Blockly.Msg.CONTROLS_FOREACH_INPUT_ITEM = '取出每個';
Blockly.Msg.CONTROLS_FOREACH_INPUT_VAR = '變量';
Blockly.Msg.CONTROLS_FOREACH_INPUT_INLIST = '自列表';
Blockly.Msg.CONTROLS_FOREACH_INPUT_INLIST_TAIL = '';
Blockly.Msg.CONTROLS_FOREACH_INPUT_DO = '執行';
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = 'For each item in a list, set the item to variable "%1", and then do some statements.';
...
Blockly.Msg.CONTROLS_IF_IF_TITLE_IF = '如果';
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = 'Add, remove, or reorder sections to reconfigure this if block.';
Blockly.Msg.CONTROLS_IF_ELSEIF_TITLE_ELSEIF = '否則如果';
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = 'Add a condition to the if block.';
Blockly.Msg.CONTROLS_IF_ELSE_TITLE_ELSE = '否則';
...
Blockly.Msg.LOGIC_NEGATE_INPUT_NOT = '非';
...
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN = 'Return the sine of a degree.';
Blockly.Msg.MATH_TRIG_TOOLTIP_COS = 'Return the cosine of a degree.';
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN = 'Return the tangent of a degree.';
...
Blockly.Msg.MATH_MODULO_INPUT_DIVIDEND = '取餘數自';
Blockly.Msg.MATH_MODULO_TOOLTIP = 'Return the remainder of dividing both numbers.';

Blockly.Msg.MATH_CONSTRAIN_HELPURL = 'http://en.wikipedia.org/wiki/Clamping_%28graphics%29';
Blockly.Msg.MATH_CONSTRAIN_INPUT_CONSTRAIN = '限制數字';
Blockly.Msg.MATH_CONSTRAIN_INPUT_LOW = '介於 (低)';
Blockly.Msg.MATH_CONSTRAIN_INPUT_HIGH = '到 (高)';
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP = 'Constrain a number to be between the specified limits (inclusive).';

Blockly.Msg.MATH_RANDOM_INT_HELPURL = 'http://en.wikipedia.org/wiki/Random_number_generation';
Blockly.Msg.MATH_RANDOM_INT_INPUT_FROM = '取隨機整數介於 (低)';
Blockly.Msg.MATH_RANDOM_INT_INPUT_TO = '到 (高)';
...
Blockly.Msg.TEXT_LENGTH_INPUT_LENGTH = '長度';
...
Blockly.Msg.TEXT_ISEMPTY_INPUT_ISEMPTY = '為空';
...
Blockly.Msg.TEXT_PRINT_TITLE_PRINT = '印出';
...
Blockly.Msg.LISTS_REPEAT_INPUT_WITH = '建立列表使用項目';
Blockly.Msg.LISTS_REPEAT_INPUT_REPEATED = '重複';
Blockly.Msg.LISTS_REPEAT_INPUT_TIMES = '次數';
...
Blockly.Msg.LISTS_INPUT_IS_EMPTY = '值為空';
...
Blockly.Msg.LISTS_INDEX_OF_INPUT_IN_LIST = '在列表';
...
Blockly.Msg.VARIABLES_GET_ITEM = '變量';
...
Blockly.Msg.VARIABLES_SET_ITEM = '變量';
...
Blockly.Msg.PROCEDURES_IFRETURN_WARNING = 'Warning: This block may only be used within a new function definition.';
