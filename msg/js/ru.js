...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "Если значение истинно, выполняет команды.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "Если значение истинно, выполняет первый блок команд. Иначе выполняется второй блок команд.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Если первое значение истинно, то выполняет первый блок команд.  Иначе, если второе значение истинно, выполняет второй блок команд.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Если первое значение истинно, то выполняет первый блок команд.  В противном случае, если второе значение истинно, выполняет второй блок команд.  Если ни одно из значений не истинно, выполняет последний блок команд.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ = "Возвращает значение истина, если параметры не равны.";
Blockly.Msg.LOGIC_NEGATE_HELPURL = "http://code.google.com/p/blockly/wiki/Not";  // untranslated
Blockly.Msg.LOGIC_NEGATE_TITLE = "не %1";
Blockly.Msg.LOGIC_NEGATE_TOOLTIP = "Возвращает значение истина, если параметр ложен.  Возвращает значение ложь, если параметр истиннен.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND = "Возвращает значение истина, если оба параметра истинны.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR = "Возвращает значение истина, если хотя бы один из параметров истиннен.";
Blockly.Msg.LOGIC_TERNARY_CONDITION = "выбор";
