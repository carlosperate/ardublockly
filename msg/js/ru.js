...
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Если первое значение истинно, то выполняет первый блок команд.
Иначе, если второе значение истинно, выполняет второй блок команд.";
