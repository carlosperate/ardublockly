...
Ports = to_bytes([80, 111, 114, 116, 115]) # "Ports"
PortName = to_bytes([80, 111, 114, 116, 78, 97, 109, 101]) # "PortName"
...
# main
def main():
    list_of_ports = sorted(comports())
    if not list_of_ports:
        print("There are no available COM ports")
    else:
