...
planepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Plane_rows">Renkennadoù : %1</span><span id="Plane_getRows">renkennadoù (%1)</span><span id="Plane_rows1">Renkennadoù a gentañ klas : %1</span><span id="Plane_getRows1">Renkennadoù a gentañ klas (%1)</span><span id="Plane_rows2">Renkennadoù a eil klas : %1</span><span id="Plane_getRows2">Renkennadoù a eil klas (%1)</span><span id="Plane_seats">Azezennoù : %1</span><span id="Plane_placeholder">?</span><span id="Plane_setSeats">azezennoù =</span></div>';
};
