...
planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = planepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><span id="title"><a href="../index.html">Blockly (Μπλοκλι)</a> : Αεροπλάνο</span> \\u0026nbsp; ';
  ...
  switch (opt_ijData.level) {
    case 1:
      output += 'Ένα αεροπλάνο έχει έναν αριθμό σειρών καθισμάτων επιβατών. Κάθε σειρά περιέχει τέσσερα καθίσματα.';
      break;
    case 2:
      output += 'Ένα αεροπλάνο έχει δύο καθίσματα στο θάλαμο διακυβέρνησης (για τον κυβερνήτη και τον συγκυβερνήτη), καθώς και έναν αριθμό από σειρές καθισμάτων επιβατών.  Κάθε σειρά θα περιέχει τέσσερα καθίσματα.';
      break;
    case 3:
  ...
  output += '</p><p>Κατασκευάστε ένα τύπο (κάτω) που θα υπολογίζει το συνολικό αριθμό καθισμάτων του αεροπλάνου καθώς αλλάζουν οι σειρές (πάνω).</p><script type="text/javascript" src="../../blockly_compressed.js"><\/script><script type="text/javascript" src="../../javascript_compressed.js"><\/script><script type="text/javascript" src="../../' + soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script><script type="text/javascript" src="blocks.js"><\/script>' + planepage.toolbox(null, null, opt_ijData) + '<div id="blockly"></div>';
  return output;
};
