...
planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = '<div id="MSG" style="display: none"><span id="rows">Rows: %1</span><span id="getRows">rows (%1)</span><span id="rows1">1st class rows: %1</span><span id="getRows1">1st class rows (%1)</span><span id="rows2">2nd class rows: %1</span><span id="getRows2">2nd class rows (%1)</span><span id="seats">Seats: %1</span><span id="placeholder">?</span><span id="setSeats">seats =</span></div><div style="display: none;"><select id="languageMenu" onchange="BlocklyApps.changeLanguage();"></select></div><h1><span id="title"><a href="../index.html">Blockly (บล็อค-ลี่)</a> : Plane</span> &nbsp; ';
