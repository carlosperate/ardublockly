...
planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  for (var i114 = 1; i114 < 4; i114++) {
    output += ' ' + ((i114 == opt_ijData.level) ? '<span class="tab" id="selected">' + soy.$$escapeHtml(i114) + '</span>' : (i114 < opt_ijData.level) ? '<a class="tab previous" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i114) + '">' + soy.$$escapeHtml(i114) + '</a>' : '<a class="tab" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i114) + '">' + soy.$$escapeHtml(i114) + '</a>');
  }
