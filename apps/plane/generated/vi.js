...
planepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="rows">Số hàng ghế: %1</span><span id="getRows">đếm số hàng ghế (%1)</span><span id="rows1">Hàng hạng nhất: %1</span><span id="getRows1">số hàng hạng nhất (%1)</span><span id="rows2">Hàng hạng hai: %1</span><span id="getRows2">số hàng hạng hai (%1)</span><span id="seats">Số chỗ ngồi: %1</span><span id="placeholder">?</span><span id="setSeats">Tính số chỗ ngồi =</span></div>';
};


planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = planepage.messages(null, null, opt_ijData) + '<div style="display: none;"><select id="languageMenu" onchange="BlocklyApps.changeLanguage();"></select></div><h1><span id="title"><a href="../index.html">Blockly</a> : Máy Bay</span> &nbsp; ';
  for (var i123 = 1; i123 < 4; i123++) {
    output += ' ' + ((i123 == opt_ijData.level) ? '<span class="tab" id="selected">' + soy.$$escapeHtml(i123) + '</span>' : (i123 < opt_ijData.level) ? '<a class="tab previous" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i123) + '">' + soy.$$escapeHtml(i123) + '</a>' : '<a class="tab" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i123) + '">' + soy.$$escapeHtml(i123) + '</a>');
  }
