...
planepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="rows">Sorok száma: %1</span><span id="getRows">Sorok száma (%1)</span><span id="rows1">1. osztály: %1 sor</span><span id="getRows1">1. osztály sorai (%1)</span><span id="rows2">2. osztály: %1 sor</span><span id="getRows2">2. osztály sorai (%1)</span><span id="seats">Ülések száma összesen: %1</span><span id="placeholder">?</span><span id="setSeats">Ülések száma =</span></div>';
};


planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = planepage.messages(null, null, opt_ijData) + '<div style="display: none;"><select id="languageMenu" onchange="BlocklyApps.changeLanguage();"></select></div><h1><span id="title"><a href="../index.html">Blockly</a> : Repülőgép</span> &nbsp; ';
