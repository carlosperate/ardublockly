...
planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = '<div id="MSG" style="display: none"><span id="rows">Số hàng ghế: %1</span><span id="getRows">đếm số hàng ghế (%1)</span><span id="rows1">Hàng hạng nhất: %1</span><span id="getRows1">số hàng hạng nhất (%1)</span><span id="rows2">Hàng hạng hai: %1</span><span id="getRows2">số hàng hạng hai (%1)</span><span id="seats">Số chỗ ngồi: %1</span><span id="setSeats">Tính số chỗ ngồi =</span></div><div style="display: none;"><select id="languageMenu" onchange="Plane.changeLanguage();"></select></div><h1><span id="title"><a href="../index.html"><span id="blocklyName">Blockly</span></a> : Máy Bay</span> &nbsp; ';
