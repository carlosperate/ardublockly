...
appsIndex.start = function(opt_data, opt_ignored) {
  return appsIndex.messages(null) + '<table><tr><td><h1><span id="title">Приложения Blockly (Блокли)</span></h1></td><td class="farSide"><select id="languageMenu"></select></td></tr><tr><td>Блокли это графическая среда программирования. Ниже приведены примеры приложений, использующих Блокли.</td></tr></table><table><tr><td><a href="puzzle/index.html"><img src="index/puzzle.png" height=80 width=100></a></td><td><div><a href="puzzle/index.html">Головоломка</a></div><div>Учитесь использовать интерфейс Блокли.</div></td></tr><tr><td><a href="maze/index.html"><img src="index/maze.png" height=80 width=100></a></td><td><div><a href="maze/index.html">Лабиринт</a></div><div>Используйте Блокли, чтобы пройти лабиринт.</div></td></tr><tr><td><a href="turtle/index.html"><img src="index/turtle.png" height=80 width=100></a></td><td><div><a href="turtle/index.html">Черепашья графика</a></div><div>Используйте Блокли для рисования.</div></td></tr><tr><td><a href="graph/index.html"><img src="index/graph.png" height=80 width=100></a></td><td><div><a href="graph/index.html">Графический калькулятор</a></div><div>Постройте график функции с Блокли.</div></td></tr><tr><td><a href="code/index.html"><img src="index/code.png" height=80 width=100></a></td><td><div><a href="code/index.html">Код</a></div><div>Переведите программу Блокли на JavaScript, Python или XML.</div></td></tr><tr><td><a href="plane/index.html"><img src="index/plane.png" height=80 width=100></a></td><td><div><a href="plane/index.html">Калькулятор мест в самолёте</a></div><div>Решите математическую задачу с одной или двумя переменными.</div></td></tr><tr><td><a href="blockfactory/index.html"><img src="index/blockfactory.png" height=80 width=100></a></td><td><div><a href="blockfactory/index.html">Фабрика блоков</a></div><div>Создайте свои блоки, используя Блокли.</div></td></tr></table><p><span id="footer_prefix"></span><a href="http://blockly.googlecode.com/">blockly.googlecode.com</a><span id="footer_suffix"></span>';
};
