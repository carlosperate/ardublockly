...
turtlepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Turtle_moveTooltip">将乌龟向前或向后移动指定的量。</span><span id="Turtle_moveForward">前移指定格数</span><span id="Turtle_moveBackward">后移指定格数</span><span id="Turtle_turnTooltip">按指定的度数向左或向右转动乌龟。</span><span id="Turtle_turnRight">右转</span><span id="Turtle_turnLeft">左转</span><span id="Turtle_widthTooltip">更改宽度。</span><span id="Turtle_setWidth">将宽度设置为</span><span id="Turtle_colourTooltip">更改画笔颜色。</span><span id="Turtle_setColour">设置颜色</span><span id="Turtle_penTooltip">提高或放下笔以停止或开始绘图。</span><span id="Turtle_penUp">拿起笔</span><span id="Turtle_penDown">放下笔</span><span id="Turtle_turtleVisibilityTooltip">使乌龟（绿色圆圈和箭头）可见或隐藏。</span><span id="Turtle_hideTurtle">隐藏乌龟</span><span id="Turtle_showTurtle">显示乌龟</span><span id="Turtle_printHelpUrl">http://zh.wikipedia.org/wiki/印刷</span><span id="Turtle_printTooltip">在龟的方向及位置绘制文本。</span><span id="Turtle_print">打印</span><span id="Turtle_fontHelpUrl">http://zh.wikipedia.org/wiki/字体</span><span id="Turtle_fontTooltip">设置打印块使用的字体。</span><span id="Turtle_font">字体</span><span id="Turtle_fontSize">字体大小</span><span id="Turtle_fontNormal">正常</span><span id="Turtle_fontBold">粗体</span><span id="Turtle_fontItalic">斜体</span><span id="Turtle_unloadWarning">离开本页面会丢失你的工作。</span></div>';
};


turtlepage.start = function(opt_data, opt_ignored, opt_ijData) {
  return turtlepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><span id="title"><a href="../index.html">Blockly</a> : 乌龟图形</span></h1></td><td class="farSide"><select id="languageMenu" onchange="BlocklyApps.changeLanguage();"></select></td></tr></table><div id="visualization"><canvas id="scratch" width="400" height="400" style="display: none"></canvas><canvas id="display" width="400" height="400"></canvas></div><table style="padding-top: 1em;"><tr><td style="width: 190px; text-align: center; vertical-align: top;"><script type="text/javascript" src="../slider.js"><\/script><svg id="slider" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="150" height="50"><!-- Slow icon. --><clipPath id="slowClipPath"><rect width=26 height=12 x=5 y=14 /></clipPath><image xlink:href="icons.png" height=42 width=84 x=-21 y=-10 clip-path="url(#slowClipPath)" /><!-- Fast icon. --><clipPath id="fastClipPath"><rect width=26 height=16 x=120 y=10 /></clipPath><image xlink:href="icons.png" height=42 width=84 x=120 y=-11 clip-path="url(#fastClipPath)" /></svg></td><td style="width: 15px;"><img id="spinner" style="visibility: hidden;" src="loading.gif" height=15 width=15></td><td style="width: 190px; text-align: center"><button id="runButton" class="primary" onclick="Turtle.runButtonClick();" title="让乌龟按照块的指令工作。"><img src="../../media/1x1.gif" class="run icon21">运行程序</button><button id="resetButton" class="primary" onclick="Turtle.resetButtonClick();" style="display: none"><img src="../../media/1x1.gif" class="stop icon21"> 重置</button></td></tr></table><div id="toolbarDiv"><button class="notext" title="查看生成的JavaScript代码。" onclick="BlocklyApps.showCode(this);"><img src=\'../../media/1x1.gif\' class="code icon21"></button><button id="linkButton" class="notext" title="保存模块并生成链接。" onclick="BlocklyStorage.link();"><img src=\'../../media/1x1.gif\' class="link icon21"></button><button class="notext" id="captureButton" title="保存该绘图。" onclick="Turtle.createImageLink();"><img src=\'../../media/1x1.gif\' class="img icon21"></button><a id="downloadImageLink" download="绘图.png"></a></div><script type="text/javascript" src="../../blockly_compressed.js"><\/script><script type="text/javascript" src="../../javascript_compressed.js"><\/script><script type="text/javascript" src="../../' + soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script><script type="text/javascript" src="blocks.js"><\/script>' + turtlepage.toolbox(null, null, opt_ijData) + '<div id="blockly"></div>' + apps.dialog(null, null, opt_ijData) + apps.codeDialog(null, null, opt_ijData) + apps.storageDialog(null, null, opt_ijData);
};
