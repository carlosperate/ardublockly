...
apps.ok = function(opt_data, opt_ignored, opt_ijData) {
  return '<div class="farSide" style="padding: 1ex 3ex 0"><button onclick="BlocklyApps.hideDialog(true)">Gerai</button></div>';
};
...
puzzlepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="Puzzle_country1">Australija</span><span id="Puzzle_country1Flag">flag_au.png</span><span id="Puzzle_country1FlagHeight">50</span><span id="Puzzle_country1FlagWidth">100</span><span id="Puzzle_country1Language">Anglų</span><span id="Puzzle_country1City1">Melburnas</span><span id="Puzzle_country1City2">Sidnėjus</span><span id="Puzzle_country1HelpUrl">http://lt.wikipedia.org/wiki/Australija</span><span id="Puzzle_country2">Vokietija</span><span id="Puzzle_country2Flag">flag_de.png</span><span id="Puzzle_country2FlagHeight">60</span><span id="Puzzle_country2FlagWidth">100</span><span id="Puzzle_country2Language">Vokiečių</span><span id="Puzzle_country2City1">Berlynas</span><span id="Puzzle_country2City2">Miunchenas</span><span id="Puzzle_country2HelpUrl">http://lt.wikipedia.org/wiki/Vokietija</span><span id="Puzzle_country3">Kinija</span><span id="Puzzle_country3Flag">flag_cn.png</span><span id="Puzzle_country3FlagHeight">66</span><span id="Puzzle_country3FlagWidth">100</span><span id="Puzzle_country3Language">Kinų</span><span id="Puzzle_country3City1">Beijingas</span><span id="Puzzle_country3City2">Šanchajus</span><span id="Puzzle_country3HelpUrl">http://lt.wikipedia.org/wiki/Kinija</span><span id="Puzzle_country4">Brazilija</span><span id="Puzzle_country4Flag">flag_br.png</span><span id="Puzzle_country4FlagHeight">70</span><span id="Puzzle_country4FlagWidth">100</span><span id="Puzzle_country4Language">Portugalų</span><span id="Puzzle_country4City1">Rio de Žaneiras</span><span id="Puzzle_country4City2">San Paulas</span><span id="Puzzle_country4HelpUrl">http://lt.wikipedia.org/wiki/Brazilija</span><span id="Puzzle_flag">vėliava:</span><span id="Puzzle_language">kalba:</span><span id="Puzzle_languageChoose">pasirinkite...</span><span id="Puzzle_cities">miestai:</span><span id="Puzzle_error0">Puiku!\nVisi %1 blokai yra teisingi</span><span id="Puzzle_error1">Beveik! Vienas blokas yra neteisingas.</span><span id="Puzzle_error2">%1 blokai yra neteisingi.</span><span id="Puzzle_tryAgain">Paryškintas blokas nėra teisingas.\nToliau bandykite.</span></div>';
};


puzzlepage.start = function(opt_data, opt_ignored, opt_ijData) {
  return puzzlepage.messages(null, null, opt_ijData) + '<table id="header" width="100%"><tr><td valign="bottom"><h1><span id="title"><a href="../index.html">Blockly</a> : Galvosūkis</span></h1></td><td class="farSide"><select id="languageMenu" onchange="BlocklyApps.changeLanguage();"></select>&nbsp; &nbsp;<button id="helpButton" onclick="Puzzle.showHelp(true);">Pagalba</button>&nbsp; &nbsp;<button id="checkButton" class="launch" onclick="Puzzle.checkAnswers();">Pasitikrinti atsakymus</button></td></tr></table><script type="text/javascript" src="../../blockly_compressed.js"><\/script><script type="text/javascript" src="../../' + soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script><script type="text/javascript" src="blocks.js"><\/script><div id="blockly"></div>' + apps.dialog(null, null, opt_ijData) + '<div id="help" class="dialogHiddenContent"><div style="padding-bottom: 0.7ex">Kiekvienai šaliai (žalia), pridėkite vėliavą, pasirinkite savo kalbą, ir padarykite savo miestų kaminą.</div><iframe src="help.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '" style="height: 200px; width: 100%; border: none;"></iframe>' + apps.ok(null, null, opt_ijData) + '</div><div id="answers" class="dialogHiddenContent"><div id="answerMessage"></div><div id="graph"><div id="graphValue"></div></div>' + apps.ok(null, null, opt_ijData) + '</div>';
};
