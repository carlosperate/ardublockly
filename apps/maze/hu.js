...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = '<div id="MSG" style="display: none"><span id="moveForward">Menj előre</span><span id="turnLeft">Fordulj balra</span><span id="turnRight">Fordulj jobbra</span><span id="doCode">akkor</span><span id="elseCode">egyébként</span><span id="pathAhead">Ha szabad az út előtted</span><span id="pathLeft">Ha szabad az út balra</span><span id="pathRight">Ha szabad az út jobbra</span><span id="repeatUntil">Ismételd a</span><span id="moveForwardTooltip">Pegman előre lép egy mezőt.</span><span id="q4wrong">No - Try tracking my direction while following the program.</span><span id="q4right">That\'s right! Good job.</span><span id="q5wrong">No - Try tracking my direction while following the program.</span><span id="q5right">You got it right!</span><span id="q10wrong">No - Try tracking my direction while following the program.</span><span id="q10right">That\'s right!</span><span id="turnTooltip">Pegman 90 fokot fordul balra, vagy jobbra.</span><span id="ifTooltip">Ha szabad az út a megadott irányban, \\nakkor végrehajtja az utasításokat. </span><span id="ifelseTooltip">Ha szabad az út a megadott irányban, \\nakkor végrehajtja az első blokkban \\nmegadott utasításokat. Egyébként a \\nmásodik blokkban szereplő utasításokat \\nhajtja végre. </span><span id="whileTooltip">A beágyazott utasításokat hajtja végre a cél \\neléréséig. </span><span id="capacity0">Nem használhatsz fel több blokkot.</span><span id="capacity1">Még 1 blokkot használhatsz fel.</span><span id="capacity2">Még %1 blokkot használhatsz fel.</span><span id="nextLevel">Congratulations! You have completed this level.</span><span id="finalLevel">Gratulálok! Sikeresen megoldottad az utolsó szintet.</span><span id="oneTopBlock">Ezen a szinten össze kell kapcsolnod minden blokkot a munkaterületen.</span></div><div id="COMMON_MSG" style="display: none"><span id="httpRequestError">A kéréssel kapcsolatban probléma merült fel.</span><span id="linkAlert">Ezzel a hivatkozással tudod megosztani a programodat:\n\n%1</span><span id="hashError">Elnézést, a \'%1\' hivatkozásnem tartozik egyetlen programhoz sem.</span><span id="xmlError">A programodat nem lehet betölteni.  Elképzelhető, hogy a Blockly egy másik verziójában készült?</span></div><table width="100%" height="100%"><tr height="88"><td colspan=3><div style="display: none;"><select id="languageMenu" onchange="BlocklyApps.changeLanguage();"></select> &nbsp; <button id="pegmanButton" onmousedown="Maze.showPegmanMenu();"><img src="../media/1x1.gif"><span>&#x25BE;</span></button></div><h1><span id="title"><a href="../index.html">Blockly</a> : Labirintus</span> &nbsp; ';
