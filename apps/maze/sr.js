...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = '<div id="MSG" style="display: none"><span id="moveForward">иди напред</span><span id="turnLeft">окрени се лево</span><span id="turnRight">окрени се десно</span><span id="doCode">ради</span><span id="elseCode">у супротном</span><span id="pathAhead">ако постоји пут напред</span><span id="pathLeft">ако постоји пут лово</span><span id="pathRight">ако постоји пут десно</span><span id="repeatUntil">понављај док не</span><span id="moveForwardTooltip">Помера Штипаљка једну позицију напред.</span><span id="q4wrong">No - Try tracking my direction while following the program.</span><span id="q4right">That\'s right! Good job.</span><span id="q5wrong">No - Try tracking my direction while following the program.</span><span id="q5right">You got it right!</span><span id="q10wrong">No - Try tracking my direction while following the program.</span><span id="q10right">That\'s right!</span><span id="turnTooltip">Окреће Штипаљка лево или десно за 90 степени.</span><span id="ifTooltip">Ако постоји пут у датом правцу, онда уради следеће.</span><span id="ifelseTooltip">Ако постоји пут у датом правцу, \\nонда изврши прву групу акција. \\nУ супротном, уради другу групу \\nакција. </span><span id="whileTooltip">Понављај следеће акције док не комплетираш задатак.</span><span id="capacity0">Број блокова који ти је остао је 0.</span><span id="capacity1">Број блокова који ти је остао је 1.</span><span id="capacity2">Број блокова који ти је остао је %1.</span><span id="nextLevel">Congratulations! You have completed this level.</span><span id="finalLevel">Честитамо! Решили сте последњи ниво.</span><span id="oneTopBlock">На овом нивоу, потребно је да поређаш све блокове у бели радни простор.</span></div><div id="COMMON_MSG" style="display: none"><span id="blocklyMessage">Blockly (Блоклијев)</span><span id="httpRequestError">Настао је проблем при извршењу траженог.</span><span id="linkAlert">Делите своје блокове употребом ове везе:\n\n%1</span><span id="hashError">Жао нам је, \'%1\' не одговара ни једној сачуваној Блокли датотеци.</span><span id="xmlError">Не могу да учитам датотеку коју сте сачували.  Можда је направљена другом верзијом Блоклија?</span></div><table width="100%" height="100%"><tr height="88"><td colspan=3><div style="display: none;" id="farSide"><select id="languageMenu" onchange="Maze.changeLanguage();"></select> &nbsp; <button id="pegmanButton" onmousedown="Maze.showPegmanMenu();"><img src="../media/1x1.gif"><span>&#x25BE;</span></button></div><h1><span id="title"><a href="../index.html"><span id="blocklyName">Blockly</span></a> : Лавиринт</span> &nbsp; ';
  ...
  output += '</div></div><svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="svgMaze" width="400px" height="450px"><g id="look"><path d="M 0,-15 a 15 15 0 0 1 15 15" /><path d="M 0,-35 a 35 35 0 0 1 35 35" /><path d="M 0,-55 a 55 55 0 0 1 55 55" /></g></svg><div id="capacityBubble"><div id="capacity"></div></div></div><table width="100%"><tr><td style="width: 190px; text-align: center; vertical-align: top;"><button title="Погледај генерисани JavaScript код." onclick="BlocklyApps.showCode();"><img src=\'../media/1x1.gif\' class="code icon21"></button><button id="linkButton" title="Сачувај и повежи са блоковима. " onclick="BlocklyStorage.link();"><img src=\'../media/1x1.gif\' class="link icon21"></button><button id="randomizeButton" title="Randomize start and finish markers. onclick="Maze.randomizeMarkers();" style="display: none"><img src=\'../media/1x1.gif\' class="random icon21"></button></td><td><button id="runButton" class="launch" onclick="Maze.runButtonClick();"><img src="../media/1x1.gif" class="run icon21"> Покрени програм</button></button><button id="resetButton" class="launch" onclick="Maze.resetButtonClick();" style="display: none"><img src="../media/1x1.gif" class="stop icon21">Поново постави</button></td></tr></table></td><td valign="top"><script type="text/javascript" src="../blockly_compressed.js"><\/script><script type="text/javascript" src="../javascript_compressed.js"><\/script><script type="text/javascript" src="../' + soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script><script type="text/javascript" src="blocks.js"><\/script>' + mazepage.toolbox(null, null, opt_ijData) + '<div id="blockly"></div></td></tr></table></div><div id="pegmanMenu"></div>';
  return output;
};
