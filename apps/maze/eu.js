...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = '<div id="MSG" style="display:none"><span id="fullTitle">Blockly Labirintoa</span><span id="moveForward">mugi aurrera</span><span id="turnLeft">biratu ezker</span><span id="turnRight">biratu eskuin</span><span id="doCode">egin</span><span id="elseCode">bestela</span><span id="pathAhead">bidea badago aurrera</span><span id="pathLeft">bidea badago ezkerrera</span><span id="pathRight">bidea badago eskuinera</span><span id="repeatUntil">arte errepikatu</span><span id="moveForwardTooltip">Pegman aurreruntz tarte bat mugitzen du.</span><span id="turnTooltip">Pegman ezkerrerantz edo eskuinerantz 90 gradu \\nbiratzen du. </span><span id="ifTooltip">Esandako norantzan bidea badago, \\nekintza batzu burutu. </span><span id="ifelseTooltip">Esandako norantzan bidea badago, \\nekintzen lehenengo blokea burutu. \\nBestela, ekintzen bigarren blokea \\nburutu. </span><span id="whileTooltip">Errepikatu barruko ekintzak bukaera punturaino \\niritsi arte. </span><span id="capacity0">0 bloke geratzen dira.</span><span id="capacity1">Bloke 1 geratzen da.</span><span id="capacity2">%1 bloke geratzen dira.</span><span id="nextLevel">Zorionak! Prest al zaude %1 mailara pasatzeko?</span><span id="finalLevel">Zorionak! Azken maila gainditu duzu.</span><span id="oneTopBlock">Maila honetan, bloke guztiak lan-eremu txurian pilatu behar dituzu.</span><span id="fullTitle">Blockly Labirintoa</span></div><table width="100%" height="100%"><tr><td width="410" valign="top"><h1><a href="http://blockly.googlecode.com/">Blockly</a> &gt; <a href="../index.html">Apps</a> &gt; Labirintoa</h1><div>Maila &nbsp;';
