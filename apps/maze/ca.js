...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = '<div id="MSG" style="display: none"><span id="moveForward">mou endavant</span><span id="turnLeft">gira esquerra</span><span id="turnRight">gira dreta</span><span id="doCode">fes</span><span id="elseCode">si no</span><span id="pathAhead">al davant</span><span id="pathLeft">si camí a l\'esquerra</span><span id="pathRight">si camí a la dreta</span><span id="repeatUntil">repeteix fins al</span><span id="moveForwardTooltip">Mou el Pegman endavant un espai.</span><span id="q4wrong">No - Try tracking my direction while following the program.</span><span id="q4right">That\'s right! Good job.</span><span id="q5wrong">No - Try tracking my direction while following the program.</span><span id="q5right">You got it right!</span><span id="q10wrong">No - Try tracking my direction while following the program.</span><span id="q10right">That\'s right!</span><span id="turnTooltip">Gira el Pegman a l\'esquerra o a la dreta 90 graus.</span><span id="ifTooltip">Si hi ha un camí en la direcció especificada, \\nllavors fes algunes accions. </span><span id="ifelseTooltip">Si hi ha un camí en la direcció especificada, \\nllavors fes el primer bloc d\'accions. \\nSi no, fes el segon bloc d\'accions. </span><span id="whileTooltip">Repeteix les accions de dins del bloc fins \\narribar al punt final. </span><span id="capacity0">Et resten 0 blocs.</span><span id="capacity1">Et resten 1 blocs.</span><span id="capacity2">Et resten %1 blocs.</span><span id="nextLevel">Congratulations! You have completed this level.</span><span id="finalLevel">Felicitats! Has resolt el nivell final.</span><span id="oneTopBlock">En aquest nivell, has d\'apilar junts tots els blocs a l\'espai de treball blanc.</span></div><div id="COMMON_MSG" style="display: none"><span id="httpRequestError">Hi ha hagut un problema amb la sol·licitud.</span><span id="linkAlert">Comparteix els teus blocs amb aquest enllaç: %1</span><span id="hashError">Ho sentim, \'%1\' no es correspon amb cap fitxer desat de Blockly.</span><span id="xmlError">No s\'ha pogut carregar el teu fitxer desat.  Potser va ser creat amb una versió diferent de Blockly?</span></div><table width="100%" height="100%"><tr height="88"><td colspan=3><div style="display: none;"><select id="languageMenu" onchange="BlocklyApps.changeLanguage();"></select> &nbsp; <button id="pegmanButton" onmousedown="Maze.showPegmanMenu();"><img src="../media/1x1.gif"><span>&#x25BE;</span></button></div><h1><span id="title"><a href="../index.html">Blockly</a> : Laberint</span> &nbsp; ';
