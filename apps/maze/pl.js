...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = '<div id="MSG" style="display: none"><span id="moveForward">idź naprzód</span><span id="turnLeft">skręć w lewo</span><span id="turnRight">skręć w prawo</span><span id="doCode">wykonaj</span><span id="elseCode">albo</span><span id="pathAhead">jeśli droga prowadzi prosto</span><span id="pathLeft">jeśli droga skręca w lewo</span><span id="pathRight">jeśli droga skręca w prawo</span><span id="repeatUntil">powtarzaj dopóki nie</span><span id="moveForwardTooltip">Przesuwa Pegman-a prosto o jedno pole.</span><span id="q4wrong">No - Try tracking my direction while following the program.</span><span id="q4right">That\'s right! Good job.</span><span id="q5wrong">No - Try tracking my direction while following the program.</span><span id="q5right">You got it right!</span><span id="q10wrong">No - Try tracking my direction while following the program.</span><span id="q10right">That\'s right!</span><span id="turnTooltip">Obraca Pegman-a w lewo lub prawo o 90 stopni.</span><span id="ifTooltip">Jeśli droga prowadzi we wskazanym kierunku, \\nwykonaj polecenia. </span><span id="ifelseTooltip">Jeśli droga prowadzi we wskazanym kierunku, \\nwykonaj pierwszy zestaw poleceń. \\nW przeciwnym razie, wykonaj drugi zestaw \\npoleceń. </span><span id="whileTooltip">Wykonuj zestaw poleceń dopóki nie osiągniesz \\npunktu końcowego. </span><span id="capacity0">Pozostało 0 poleceń.</span><span id="capacity1">Wykorzystano 1 polecenie.</span><span id="capacity2">Wykorzystano %1 poleceń.</span><span id="nextLevel">Congratulations! You have completed this level.</span><span id="finalLevel">Gratulacje! Ostatni poziom został rozwiązany.</span><span id="oneTopBlock">Na tym poziomie, ustaw wszystkie polecania na białym polu.</span></div><div id="COMMON_MSG" style="display: none"><span id="blocklyMessage">Blockly</span><span id="httpRequestError">Wystąpił problem z przesłaniem żądania.</span><span id="linkAlert">Udostępnij link ze swoimi poleceniami:\n\n%1</span><span id="hashError">Przepraszamy, \'%1\' jest nieodpowiedni do zapisanych plików Blockly.</span><span id="xmlError">Nie można wgrać pliku.  Może plik został zapisany w innej wersji Blockly?</span></div><table width="100%" height="100%"><tr height="88"><td colspan=3><div style="display: none;" id="farSide"><select id="languageMenu" onchange="Maze.changeLanguage();"></select> &nbsp; <button id="pegmanButton" onmousedown="Maze.showPegmanMenu();"><img src="../media/1x1.gif"><span>&#x25BE;</span></button></div><h1><span id="title"><a href="../index.html"><span id="blocklyName">Blockly</span></a> : Labirynt</span> &nbsp; ';
  ...
  output += '</div></div><svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="svgMaze" width="400px" height="450px"><g id="look"><path d="M 0,-15 a 15 15 0 0 1 15 15" /><path d="M 0,-35 a 35 35 0 0 1 35 35" /><path d="M 0,-55 a 55 55 0 0 1 55 55" /></g></svg><div id="capacityBubble"><div id="capacity"></div></div></div><table width="100%"><tr><td style="width: 190px; text-align: center; vertical-align: top;"><button title="Zobacz utworzony kod JavaScript." onclick="BlocklyApps.showCode();"><img src=\'../media/1x1.gif\' class="code icon21"></button><button id="linkButton" title="Podziel się swoim programem." onclick="BlocklyStorage.link();"><img src=\'../media/1x1.gif\' class="link icon21"></button><button id="randomizeButton" title="Randomize start and finish markers. onclick="Maze.randomizeMarkers();" style="display: none"><img src=\'../media/1x1.gif\' class="random icon21"></button></td><td><button id="runButton" class="launch" onclick="Maze.runButtonClick();"><img src="../media/1x1.gif" class="run icon21"> Uruchom program</button></button><button id="resetButton" class="launch" onclick="Maze.resetButtonClick();" style="display: none"><img src="../media/1x1.gif" class="stop icon21">Wyczyść</button></td></tr></table></td><td valign="top"><script type="text/javascript" src="../blockly_compressed.js"><\/script><script type="text/javascript" src="../javascript_compressed.js"><\/script><script type="text/javascript" src="../' + soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script><script type="text/javascript" src="blocks.js"><\/script>' + mazepage.toolbox(null, null, opt_ijData) + '<div id="blockly"></div></td></tr></table></div><div id="pegmanMenu"></div>';
  return output;
};
