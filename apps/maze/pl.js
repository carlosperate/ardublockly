...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = '<div id="MSG" style="display:none"><span id="fullTitle">Labirynt z Blockly</span><span id="moveForward">idź naprzód</span><span id="turnLeft">skręć w lewo</span><span id="turnRight">skręć w prawo</span><span id="doCode">wykonaj</span><span id="elseCode">albo</span><span id="pathAhead">jeśli droga prowadzi prosto</span><span id="pathLeft">jeśli droga skręca w lewo</span><span id="pathRight">jeśli droga skręca w prawo</span><span id="repeatUntil">powtarzaj dopóki nie</span><span id="moveForwardTooltip">Przesuwa Pegman-a prosto o jedno pole.</span><span id="turnTooltip">Obraca Pegman-a w lewo lub prawo o 90 stopni.</span><span id="ifTooltip">Jeśli droga prowadzi we wskazanym kierunku, \\nwykonaj polecenia. </span><span id="ifelseTooltip">Jeśli droga prowadzi we wskazanym kierunku, \\nwykonaj pierwszy zestaw poleceń. \\nW przeciwnym razie, wykonaj drugi zestaw \\npoleceń. </span><span id="whileTooltip">Wykonuj zestaw poleceń dopóki nie osiągniesz \\npunktu końcowego. </span><span id="capacity0">Pozostało 0 poleceń.</span><span id="capacity1">Wykorzystano 1 polecenie.</span><span id="capacity2">Wykorzystano %1 poleceń.</span><span id="nextLevel">Gratulacje! Czy chcesz przejść na poziom %1?</span><span id="finalLevel">Gratulacje! Ostatni poziom został rozwiązany.</span><span id="oneTopBlock">Na tym poziomie, ustaw wszystkie polecania na białym polu.</span><span id="fullTitle">Labirynt z Blockly</span></div><table width="100%" height="100%"><tr><td width="410" valign="top"><h1><a href="http://blockly.googlecode.com/">Blockly</a> &gt; <a href="../index.html">Apps</a> &gt; Labirynt</h1><div>Poziom &nbsp;';
  ...
  output += '</div></div><svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="svgMaze" width="400px" height="450px"><g id="look"><path d="M 0,-15 a 15 15 0 0 1 15 15" /><path d="M 0,-35 a 35 35 0 0 1 35 35" /><path d="M 0,-55 a 55 55 0 0 1 55 55" /></g></svg><div id="capacityBubble"><div id="capacity"></div></div></div><table width="100%"><tr><td style="width: 190px; text-align: center"><button title="Zobacz utworzony kod JavaScript." onclick="Blockly.Apps.showCode();"><img src=\'../../media/1x1.gif\' class="code"></button><button id="linkButton" title="Podziel się swoim programem." onclick="BlocklyStorage.link();"><img src=\'../../media/1x1.gif\' class="link"></button><button id="randomizeButton" title="Wylosuj początek i koniec drogi. onclick="Maze.randomizeMarkers();" style="display: none"><img src=\'../../media/1x1.gif\' class="random"></button></td><td style="width: 15px;"><img id="spinner" style="visibility: hidden;" src="loading.gif" height=15 width=15></td><td><button id="runButton" class="launch" onclick="Maze.runButtonClick();">Uruchom program</button><button id="resetButton" class="launch" onclick="Maze.resetButtonClick();" style="display: none">Wyczyść</button></td></tr></table></td><td valign="top"><script type="text/javascript" src="../../blockly_compressed.js"><\/script><script type="text/javascript" src="../../generators/javascript.js"><\/script><script type="text/javascript" src="../common.js"><\/script><script type="text/javascript">Blockly.Apps.loadLanguageScripts(languageSrc);<\/script><script type="text/javascript" src="blocks.js"><\/script>' + mazepage.toolbox(null, null, opt_ijData) + '<div id="blockly"></div></td></tr></table>';
  return output;
};
