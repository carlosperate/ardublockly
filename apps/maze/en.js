...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = '<div id="MSG" style="display:none"><span id="fullTitle">Blockly Maze</span><span id="moveForward">move forward</span><span id="turnLeft">turn left</span><span id="turnRight">turn right</span><span id="doCode">do</span><span id="elseCode">else</span><span id="pathAhead">if path ahead</span><span id="pathLeft">if path to the left</span><span id="pathRight">if path to the right</span><span id="repeatUntil">repeat until</span><span id="moveForwardTooltip">Moves Pegman forward one space.</span><span id="turnTooltip">Turns Pegman left or right by 90 degrees.</span><span id="ifTooltip">If there is a path in the specified direction, then do some actions.</span><span id="ifelseTooltip">If there is a path in the specified direction, then do the first block of actions. Otherwise, do the second block of actions.</span><span id="whileTooltip">Repeat the enclosed actions until finish point is reached.</span><span id="capacity0">You have <span id=\'capacityNumber\'>0</span> blocks left.</span><span id="capacity1">You have <span id=\'capacityNumber\'>1</span> block left.</span><span id="capacity2">You have <span id=\'capacityNumber\'>%1</span> blocks left.</span><span id="nextLevel">Congratulations! Are you ready to proceed to level %1?</span><span id="finalLevel">Congratulations! You have solved the final level.</span><span id="oneTopBlock">On this level, you need to stack together all of the blocks in the white workspace.</span><span id="fullTitle">Blockly Maze</span></div><table width="100%" height="100%"><tr height="50"><td colspan=2><h1><a href="http://blockly.googlecode.com/">Blockly</a> &gt; <a href="../index.html">Apps</a> &gt; Maze&nbsp;';
  for (var i109 = 1; i109 < 11; i109++) {
    output += ' ' + ((i109 == opt_ijData.level) ? '<span class="tab" id="selected">' + soy.$$escapeHtml(i109) + '</span>' : (i109 < opt_ijData.level) ? '<a class="tab previous" href="?level=' + soy.$$escapeHtml(i109) + '">' + soy.$$escapeHtml(i109) + '</a>' : '<a class="tab" href="?level=' + soy.$$escapeHtml(i109) + '">' + soy.$$escapeHtml(i109) + '</a>');
  }
