...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  switch (opt_ijData.level) {
    case 1:
      output += 'Empiler ensemble deux blocs d’instructions \'avance\' pour m’aider à atteindre le but.';
      break;
    case 2:
    ...
    case 4:
      ...
      break;
    case 5:
      output += 'Diviser un problème en deux parties peut rendre les choses plus simples.';
      break;
    case 6:
