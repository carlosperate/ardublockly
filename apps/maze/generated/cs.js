...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Maze_moveForward">pohyb vpřed</span><span id="Maze_turnLeft">otočit levá</span><span id="Maze_turnRight">otočit pravá</span><span id="Maze_doCode">udělej</span><span id="Maze_elseCode">jinak</span><span id="Maze_pathAhead">pokud cesta vpřed</span><span id="Maze_pathLeft">pokud cesta doleva</span><span id="Maze_pathRight">pokud cesta doprava</span><span id="Maze_repeatUntil">opakuj až do</span><span id="Maze_moveForwardTooltip">Pohne Pegmanem vpřed o jedno pole.</span><span id="Maze_turnTooltip">Otočí Pegmana vlevo nebo vpravo o 90 stupňů.</span><span id="Maze_ifTooltip">Pokud je v daném směru cesta, pak proveď nějakou \\nakci. </span><span id="Maze_ifelseTooltip">Pokud je v danném směru cesta, \\npak proveď posloupnost akcí. V \\nopačném případě proveď druhou \\nposloupnost akcí. </span><span id="Maze_whileTooltip">Opakuj obsažené akce do té doby, \\ndokud není dosažen cílový bod. </span><span id="Maze_capacity0">Počet zbývajících bloků 0.</span><span id="Maze_capacity1">Počet zbývajících bloků 1.</span><span id="Maze_capacity2">Počet zbývajících bloků %1.</span><span id="Maze_nextLevel">Blahopřejeme! Jsi připraven vstoupit do levelu %1?</span><span id="Maze_finalLevel">Blahopřejeme! Vyřešil jsi poslední level.</span></div>';
};
...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  switch (opt_ijData.level) {
    case 1:
      output += 'Poskládej několik pohybů vpřed dohromady a pomoc mi dosáhnout cíle.';
      break;
    case 2:
  ...
  output += '</div></div><svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="svgMaze" width="400px" height="450px"><g id="look"><path d="M 0,-15 a 15 15 0 0 1 15 15" /><path d="M 0,-35 a 35 35 0 0 1 35 35" /><path d="M 0,-55 a 55 55 0 0 1 55 55" /></g></svg><div id="capacityBubble"><div id="capacity"></div></div></div><table width="400"><tr><td style="width: 190px; text-align: center; vertical-align: top;"><button class="notext" title="Zobraz generovaný JavaScriptový kód." onclick="BlocklyApps.showCode(this);"><img src="../../media/1x1.gif" class="code icon21"></button><button id="linkButton" class="notext" title="Ulož a spoj bloky.." onclick="BlocklyStorage.link();"><img src="../../media/1x1.gif" class="link icon21"></button></td><td><button id="runButton" class="primary" onclick="Maze.runButtonClick();" title="Makes the player do what the blocks say."><img src="../../media/1x1.gif" class="run icon21"> Spusť program</button><button id="resetButton" class="primary" onclick="Maze.resetButtonClick();" style="display: none" title="Put the player back at the start of the maze."><img src="../../media/1x1.gif" class="stop icon21"> Reset</button></td></tr></table><script type="text/javascript" src="../../blockly_compressed.js"><\/script><script type="text/javascript" src="../../javascript_compressed.js"><\/script><script type="text/javascript" src="../../' + soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script><script type="text/javascript" src="blocks.js"><\/script>' + mazepage.toolbox(null, null, opt_ijData) + '<div id="blockly"></div><div id="pegmanMenu"></div>' + apps.dialog(null, null, opt_ijData) + apps.codeDialog(null, null, opt_ijData) + apps.storageDialog(null, null, opt_ijData) + '<div id="dialogDone" class="dialogHiddenContent"><div id="dialogDoneText" style="font-size: large; margin: 1em;"></div><img src="../../media/1x1.gif" id="pegSpin"><div id="dialogDoneButtons" class="farSide" style="padding: 1ex 3ex 0"></div></div><div id="dialogOneTopBlock" class="dialogHiddenContent"><div>V tomto levelu musíš posbírat všechny bloky na bílém pozadí.</div><iframe id="iframeOneTopBlock" src=""></iframe>' + apps.ok(null, null, opt_ijData) + '</div>';
  return output;
};
