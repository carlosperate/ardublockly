...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  switch (opt_ijData.level) {
    case 1:
      output += 'ブロックを並べるとプログラムができます。「まっすぐ進む」のブロックをいくつか縦につないで、ゴールに連れて行ってください。';
      break;
    case 2:
      output += '道に沿って進むにはどれをどのように並べたらいいですか?';
      break;
    case 3:
      output += 'コンピューターの記憶には限りがあります。2 個のブロックだけでゴールしてください。ブロックを繰り返し実行する「繰り返し」を使ってください。';
      break;
    case 4:
      output += '5 個のブロックだけでゴールしてください。';
      break;
    case 5:
      output += 'ペグマンは、まっすぐ進めないときは左に曲がらなければなりません。';
      break;
    case 6:
      output += '「if」(もし) ブロックは条件が正しいときだけ何か動作をします。左に進めるときは左を向くようにしてみてください。';
      break;
    case 7:
      output += 'この迷路は 1 つ前の迷路より難しそうに見えるかもしれませんが、難しくはありません。';
      break;
    case 8:
      output += '「if」(もし) ブロックは 1 回以上使えます。';
      break;
    case 9:
      output += '「if-else」(もし-それ以外) ブロックでは、一方ともう一方の 2 つのことができます。';
      break;
    case 10:
      output += 'この難しい迷路を解けますか? 左側の壁をたどってみてください。上級のプログラマー向けの迷路です!';
      break;
  }
  output += '</div></div><svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="svgMaze" width="400px" height="450px"><g id="look"><path d="M 0,-15 a 15 15 0 0 1 15 15" /><path d="M 0,-35 a 35 35 0 0 1 35 35" /><path d="M 0,-55 a 55 55 0 0 1 55 55" /></g></svg><div id="capacityBubble"><div id="capacity"></div></div></div><table width="400"><tr><td style="width: 190px; text-align: center; vertical-align: top;"><button class="notext" title="生成された JavaScript コードを表示します。" onclick="BlocklyApps.showCode(this);"><img src="../../media/1x1.gif" class="code icon21"></button><button id="linkButton" class="notext" title="ブロックの状態を保存してリンクを取得します。" onclick="BlocklyStorage.link();"><img src="../../media/1x1.gif" class="link icon21"></button></td><td><button id="runButton" class="primary" onclick="Maze.runButtonClick();" title="並べたブロックの動作を、キャラクターに実行させます。"><img src="../../media/1x1.gif" class="run icon21"> プログラムを実行</button><button id="resetButton" class="primary" onclick="Maze.resetButtonClick();" style="display: none" title="キャラクターを迷路の最初の場所に戻します。"><img src="../../media/1x1.gif" class="stop icon21"> リセット</button></td></tr></table><script type="text/javascript" src="../../blockly_compressed.js"><\/script><script type="text/javascript" src="../../javascript_compressed.js"><\/script><script type="text/javascript" src="../../' + soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script><script type="text/javascript" src="blocks.js"><\/script>' + mazepage.toolbox(null, null, opt_ijData) + '<div id="blockly"></div><div id="pegmanMenu"></div>' + apps.dialog(null, null, opt_ijData) + apps.codeDialog(null, null, opt_ijData) + apps.storageDialog(null, null, opt_ijData) + '<div id="dialogDone" class="dialogHiddenContent"><div id="dialogDoneText" style="font-size: large; margin: 1em;"></div><img src="../../media/1x1.gif" id="pegSpin"><div id="dialogDoneButtons" class="farSide" style="padding: 1ex 3ex 0"></div></div><div id="dialogOneTopBlock" class="dialogHiddenContent"><div>On this level, you need to stack together all of the blocks in the white workspace.</div><iframe id="iframeOneTopBlock" src=""></iframe>' + apps.ok(null, null, opt_ijData) + '</div>';
  return output;
};
