...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="httpRequestError">Настао је проблем при извршењу траженог.</span><span id="linkAlert">Делите своје блокове употребом ове везе:\n\n%1</span><span id="hashError">Жао нам је, \'%1\' не одговара ни једној сачуваној Блокли датотеци.</span><span id="xmlError">Не могу да учитам датотеку коју сте сачували.  Можда је направљена другом верзијом Блоклија?</span><span id="moveForward">иди напред</span><span id="turnLeft">окрени се лево</span><span id="turnRight">окрени се десно</span><span id="doCode">ради</span><span id="elseCode">у супротном</span><span id="pathAhead">ако постоји пут напред</span><span id="pathLeft">ако постоји пут лово</span><span id="pathRight">ако постоји пут десно</span><span id="repeatUntil">понављај док не</span><span id="moveForwardTooltip">Помера Штипаљка једну позицију напред.</span><span id="turnTooltip">Окреће Штипаљка лево или десно за 90 степени.</span><span id="ifTooltip">Ако постоји пут у датом правцу, онда уради следеће.</span><span id="ifelseTooltip">Ако постоји пут у датом правцу, \\nонда изврши прву групу акција. \\nУ супротном, уради другу групу \\nакција. </span><span id="whileTooltip">Понављај следеће акције док не комплетираш задатак.</span><span id="capacity0">Број блокова који ти је остао је 0.</span><span id="capacity1">Број блокова који ти је остао је 1.</span><span id="capacity2">Број блокова који ти је остао је %1.</span><span id="nextLevel">Честитамо! Да ли сте спремни да пређете на ниво %1?</span><span id="finalLevel">Честитамо! Решили сте последњи ниво.</span></div>';
};
