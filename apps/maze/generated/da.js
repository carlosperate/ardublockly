...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="httpRequestError">Der var et problem med forespørgslen.</span><span id="linkAlert">Del dine blokke med dette link:\n\n%1</span><span id="hashError">Beklager, \'%1\' passer ikke med nogen gemt Blockly fil.</span><span id="xmlError">Kunne ikke hente din gemte fil.  Måske er den lavet med en anden udgave af Blockly?</span><span id="moveForward">flyt fremad</span><span id="turnLeft">drej venstre</span><span id="turnRight">drej højre</span><span id="doCode">gør</span><span id="elseCode">ellers</span><span id="pathAhead">hvis sti foran</span><span id="pathLeft">hvis sti til venstre</span><span id="pathRight">hvis sti til højre</span><span id="repeatUntil">gentag indtil</span><span id="moveForwardTooltip">Flytter pindemand et tern fremad.</span><span id="turnTooltip">Drejer pindemand 90 grader til højre eller venstre.</span><span id="ifTooltip">Hvis der er en sti i den angivne retning, \\nså udfør nogle handlinger. </span><span id="ifelseTooltip">Hvis der er en sti i den angivne retning, \\nså udfør den første handlingsblok. \\nHvis ikke, så udfør den anden handlingsblok. </span><span id="whileTooltip">Gentag handlingsblok indtil slutpunktet er nået.</span><span id="capacity0">Du har 0 blokke tilbage.</span><span id="capacity1">Du har 1 blok tilbage.</span><span id="capacity2">Du har %1 blokke tilbage.</span><span id="nextLevel">Tillykke! Er du klar til at fortsætte til bane %1?</span><span id="finalLevel">Tillykke! Du har klaret den sidste bane!.</span></div>';
};
