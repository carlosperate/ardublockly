...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  switch (opt_ijData.level) {
    case 1:
      output += 'Сгруппируйте несколько \'идите вперёд\' блоков, чтобы помочь мне достичь цели.';
      break;
    case 2:
