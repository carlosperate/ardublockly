...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = '<div id="MSG" style="display: none"><span id="moveForward">идите вперёд</span><span id="turnLeft">повернитесь налево</span><span id="turnRight">повернитесь направо</span><span id="doCode">сделайте </span><span id="elseCode">иначе</span><span id="pathAhead">если путь впереди</span><span id="pathLeft">если путь cлева</span><span id="pathRight">если путь cправа</span><span id="repeatUntil">повторяйте пока не</span><span id="moveForwardTooltip">Продвиньте Пегмена вперёд на один шаг.</span><span id="q4wrong">No - Try tracking my direction while following the program.</span><span id="q4right">That\'s right! Good job.</span><span id="q5wrong">No - Try tracking my direction while following the program.</span><span id="q5right">You got it right!</span><span id="q10wrong">No - Try tracking my direction while following the program.</span><span id="q10right">That\'s right!</span><span id="turnTooltip">Поверните Пегмена на 90 градусов влево или вправо.</span><span id="ifTooltip">Если путь в указанном направление действителен, \\nто произведите какие-нибудь действия. </span><span id="ifelseTooltip">Если путь в указанном направление действителен, \\nто произведите первый блок действий . \\nИначе, произведите второй блок действий. </span><span id="whileTooltip">Повторяйте действия заключенные в скобках до \\nдостижения конечной точки. </span><span id="capacity0">У вас осталось 0 блоков.</span><span id="capacity1">У вас осталось 1 блоков.</span><span id="capacity2">У вас осталось %1 блоков.</span><span id="nextLevel">Congratulations! You have completed this level.</span><span id="finalLevel">Поздравляем! Вы прошли заключительный уровень.</span><span id="oneTopBlock">На данном уровне вам необходимо сложить вместе все блоки на белом рабочем поле.</span></div><div id="COMMON_MSG" style="display: none"><span id="httpRequestError">Произошла проблема при запросе.</span><span id="linkAlert">Поделитесь своими блоками по этой ссылке:\n\n%1</span><span id="hashError">К сожалению, \'%1\' не соответствует ни одному сохраненному файлу Блокли.</span><span id="xmlError">Не удалось загрузить ваш сохраненный файл.  Возможно, он был создан с другой версией Блокли?</span></div><table width="100%" height="100%"><tr height="88"><td colspan=3><div style="display: none;"><select id="languageMenu" onchange="BlocklyApps.changeLanguage();"></select> &nbsp; <button id="pegmanButton" onmousedown="Maze.showPegmanMenu();"><img src="../media/1x1.gif"><span>&#x25BE;</span></button></div><h1><span id="title"><a href="../index.html">Blockly (Блoкли)</a> : Лабиринт</span> &nbsp; ';
