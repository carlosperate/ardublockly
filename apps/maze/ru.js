...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = '<div id="MSG" style="display:none"><span id="fullTitle">Blockly (Блoкли) Лабиринт</span><span id="moveForward">идите вперёд</span><span id="turnLeft">повернитесь налево</span><span id="turnRight">повернитесь направо</span><span id="doCode">сделайте </span><span id="elseCode">иначе</span><span id="pathAhead">если путь впереди</span><span id="pathLeft">если путь cлева</span><span id="pathRight">если путь cправа</span><span id="repeatUntil">повторяйте пока не</span><span id="moveForwardTooltip">Продвиньте Пегмена вперёд на один шаг.</span><span id="turnTooltip">Поверните Пегмена на 90 градусов влево или вправо.</span><span id="ifTooltip">Если путь в указанном направление действителен, \\nто произведите какие-нибудь действия. </span><span id="ifelseTooltip">Если путь в указанном направление действителен, \\nто произведите первый блок действий . \\nИначе, произведите второй блок действий. </span><span id="whileTooltip">Повторяйте действия заключенные в скобках до \\nдостижения конечной точки. </span><span id="capacity0">У вас осталось 0 блоков.</span><span id="capacity1">У вас осталось 1 блоков.</span><span id="capacity2">У вас осталось %1 блоков.</span><span id="nextLevel">Поздравляем! Вы готовы перейти на уровень%1?</span><span id="finalLevel">Поздравляем! Вы прошли заключительный уровень.</span><span id="oneTopBlock">На данном уровне вам необходимо сложить вместе все блоки на белом рабочем поле.</span><span id="fullTitle">Blockly (Блoкли) Лабиринт</span></div><table width="100%" height="100%"><tr><td width="410" valign="top"><h1><a href="http://blockly.googlecode.com/">Blockly</a> &gt; <a href="../index.html">Apps</a> &gt; Лабиринт</h1><div>Уровень &nbsp;';
  ...
  output += '</div></div><svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="svgMaze" width="400px" height="450px"><g id="look"><path d="M 0,-15 a 15 15 0 0 1 15 15" /><path d="M 0,-35 a 35 35 0 0 1 35 35" /><path d="M 0,-55 a 55 55 0 0 1 55 55" /></g></svg><div id="capacityBubble"><div id="capacity"></div></div></div><table width="100%"><tr><td style="width: 190px; text-align: center"><button title="См. полученный код JavaScript. " onclick="Blockly.Apps.showCode();"><img src=\'../../media/1x1.gif\' class="code"></button><button id="linkButton" title="Сохраните и закрепите за блоком." onclick="BlocklyStorage.link();"><img src=\'../../media/1x1.gif\' class="link"></button><button id="randomizeButton" title="Создайте произвольные начальную и конечную точки. onclick="Maze.randomizeMarkers();" style="display: none"><img src=\'../../media/1x1.gif\' class="random"></button></td><td style="width: 15px;"><img id="spinner" style="visibility: hidden;" src="loading.gif" height=15 width=15></td><td><button id="runButton" class="launch" onclick="Maze.runButtonClick();">Запустить Программу</button><button id="resetButton" class="launch" onclick="Maze.resetButtonClick();" style="display: none">Сбросить</button></td></tr></table></td><td valign="top"><script type="text/javascript" src="../../blockly_compressed.js"><\/script><script type="text/javascript" src="../../generators/javascript.js"><\/script><script type="text/javascript" src="../common.js"><\/script><script type="text/javascript">Blockly.Apps.loadLanguageScripts(languageSrc);<\/script><script type="text/javascript" src="blocks.js"><\/script>' + mazepage.toolbox(null, null, opt_ijData) + '<div id="blockly"></div></td></tr></table>';
  return output;
};
