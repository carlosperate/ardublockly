...
codepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Code_badXml">Mistak parsin XML:\n%1\n\nSelect \'OK\' tae hiff yer chynges or \'Cancel\' tae further eidit the XML.</span><span id="Code_badCode">Program mistak:\n%1</span><span id="Code_timeout">Mucklest execûtion iterations exceeded.</span><span id="Code_discard">Delyte aw %1 blocks?</span></div>';
};
